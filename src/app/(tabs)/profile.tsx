...
export default function ProfileScreen() {
  ...
  return <Screen title="Tu espacio"><Card><Copy variant="title">{data.user.name}</Copy><Copy muted>Semestre {data.user.semester} · Bogotá · COP</Copy><Badge>PERFIL DE DEMOSTRACIÓN</Badge></Card>
    ...
    <Card><Copy variant="heading">JARVIS Mobile</Copy><Copy muted>Datos guardados en este dispositivo. La demostración usa el 8 de septiembre de 2026 como fecha de referencia.</Copy><Copy variant="mono" muted>VERSIÓN 0.2 · REACT NATIVE + EXPO</Copy></Card>
  </Screen>;
}
